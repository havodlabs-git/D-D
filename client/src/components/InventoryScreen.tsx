...
export function InventoryScreen({ onClose }: InventoryScreenProps) {
  ...
  const slots = [
    ...
    { id: "helmet", name: "Elmo", sprite: "/sprites/items/helmet.png" },
    { id: "boots", name: "Botas", sprite: "/sprites/items/boots.png" },
    { id: "gloves", name: "Luvas", sprite: "/sprites/items/gloves.png" },
    { id: "ring1", name: "Anel 1", sprite: "/sprites/items/ring.png" },
    { id: "ring2", name: "Anel 2", sprite: "/sprites/items/ring.png" },
    { id: "amulet", name: "Amuleto", sprite: "/sprites/items/amulet.png" },
  ];
